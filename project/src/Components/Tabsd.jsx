    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider',display:"flex",flexDirection:"row",justifyContent:"center"}}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
          ...
          <Tab label="Time Tracking" {...a11yProps(4)} />
          <Tab label="Reporting" {...a11yProps(5)} />
          <Tab label="Mobile" {...a11yProps(6)} />
        </Tabs>
      </Box>
...
Impress clients with professional Invoices that clearly show the work you’ve done and what it costs…then, just click send. Oh, and use automated payment reminders to nudge clients for payment.
      <br/><br/><Button variant='contained' sx={{backgroundColor:"#afc1c9",color:"black"}}>TRY IT FREE</Button>
      </CustomTabPanel>
...
<br/><br/><Button variant='contained' sx={{backgroundColor:"#afc1c9",color:"black"}}>TRY IT FREE</Button>
      ...
      <h3>Track Time to the Minute</h3>
You (and your team) work on lots of projects at once, and missing billable time can be costly. Time Tracking in BalanceBliss makes it easy for teams to log time and automatically add it to invoices, so all time is accounted for.
<br/><br/><Button variant='contained' sx={{backgroundColor:"#afc1c9",color:"black"}}>TRY IT FREE</Button>
      </CustomTabPanel>
